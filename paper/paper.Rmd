...
for the macroscopic process and a *linear* Fokker-Planck equation which
governs the *deviations* from the macroscopic equation:
...
postulated by the canonical equation, which corresponds to a 
non-linear Fokker-Planck equation for the probability density.  
