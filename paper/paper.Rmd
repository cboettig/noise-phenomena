...
particularly in higher-dimensional disease and outbreak models [@Blarer1999; @Greeman2003; @McKane2005; @Alonso2007; @Black2010].
...
More broadly, examples of early warning signals such as increasing variance,
auto-correlation, and flickering all point to ways in which stochasticity
and noise-driven phenomena can be transformed from something which obscures
underlying processes to something which reveals them.  I believe this is
role could apply far more broadly than in just the context of stability and
tipping points.  The examples from fold bifurcations already suggest
...
and many others, _e.g._ see @Scheffer2015 review] has served not merely
