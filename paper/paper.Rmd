...
modeling: variables of interest to the processes
...
<!-- Need concise overview of stochasticity literature --> 
...
series.  Faced with such uncertainty, it is tempting to abandon
any such attempts until much longer and higher resolution data 
becomes available. Fortunately, this has not been the path taken.
