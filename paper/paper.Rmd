...
the interaction of ecological and evolutionary processes [@Saether1997; @Ozgul2009; @Lenormand2009; @Vindenes2015; @Schreiber2015],
not to mention the extensive literature in stochastic evolution and popluation genetics
[e.g. @Ewens2004, @Lewontin1969].  


While acknowledging more realistic examples and more general results where available,
using specific and familiar simple models -- just complex enough to illustrate
...
Few topics have recieved greater attention then the question of
the persistence of a given species [@Kendall1949;  @Bartlett1955; @Bartlett1960; @Lande1993; @Saether1998; @Coulson2001; @Schreiber2010]
