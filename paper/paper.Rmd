...
measurements are effectively independent (white noise). 
...
spatial heterogeneity, magnitude of noise, degree of autocorrelation and so forth
[e.g. @Higgins1997; @Coulson2001; @Melbourne2008; @Hart2016];
indeed care must be taken even in defining the approriate notion of 
...
<!-- FIXME Fragment, also tie back to flickering results, move some of that here-->
