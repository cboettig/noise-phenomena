...
but unlike the canonical model, leads to explicitly autocorrelated noise 
...
formulations start from the empirical observation of autocorrelation 
...
magnitudes of the autocorrelation time of the environmental dynamics and population dynamics.)
An environment with comparatively short autocorrelation scale will act
...
and autocorellation.  The system size expansion illustrates how we replace
...
see appendix B.) Thus for the Levin's model, we can capture the fluctuations
...
<!-- More frank introduction to this section, see reply to Reviewer 1-->
