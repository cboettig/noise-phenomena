...
driving many interesting phenomena.  Yet this transistion from "noise the nuisance"
...
It is easy to critique such simple models: ecology is complex, and much effort
...
<!-- Shorten this, more citations, more focus -->
...
between stochastic summary and underlying process more precise:
that is, on understanding the origins of noise [@Coulson2004]. 



Over the past several decades, research into stochastic modeling
has 
...
root of the "system size," [@vanKampen2007] so that for very large populations the
