...
source for new opportunities for inference.  This shift in how we think about noise
is nonetheless easy to miss in the extensive literature 

Origins of noise and motivation for studying stochastic models @Kendall1949 and @Bartlett1960


This trend from nuisance to creator
to informer is of course not the only or the most obvious trend in the 
extensive literature on stochastic modeling over the past few decades, but rather,
an instructive lens in which to draw out a lar



@Bjornstad2001 @Coulson2001 @Coulson2004

I will focus on examples that
illustrate this larger arc in how we are thinking about stochasticity as the role
it plays.  


(e.g. see in particular
@Couslon2004, @Ovaskainen2010 on population extinction with 
a focus on environmental and colored noise, @Black2012 on intrinsic / demographic noise,





Few topics have recieved greater attention then the question of
the persistence of a given species [@Kendall1949;  @Bartlett1960; @Lande1993; @Saether1998; @Coulson2001; @Schreiber2010]

Excellent reviews and textbook introductions 





@Bartlett1960 @Bjornstad2001 @Coulson2001 @Lande2003



See in particular reviews by @Ovaskainen2010 and @Schreiber2012
...
The extensive literature on demographic and environmental noise has been
frequently reviewed elsewhere [@Black2012]
...
I will anchor each of these sections using concrete examples from simple models.
It is easy to critique such simple models: after all, one might summarize decades
of research in noting the twin observations that (1)  ecology is complex and (2)
that complexity is important. In the stochasticty literature alone, much work 
...
@Chesson1982; @Chesson1985; @Chesson1989; @Melbourne2007; @Schreiber2017]; species traits
and the interaction of ecological and evolutionary processes [@Ozgul2009; @Lenormand2009; @Vindesens2015; @Schreiber2015],
not to mention the extensive literature in stochastic evolution and popluation genetics
[e.g. Ewens, @Lewontin1969]



and the role of stochasticity in more complex models, particularly in structured populations (matrix models), 


in


has been spent on illustrating the importance that complexity: age and stage
structure, spatial structure, individual heterogeneity, evolution, non-stationary environments,
species network interactions, and much more [e.g. @Durrett1994; @Bjornstad2001].
While acknowledging more realistic examples and more general results where avialable,
using specific and familiar simple models that -- just complex enough to illustrate
the phenomenon but no more -- will provide us with a platform that is more accessible 
to both intution and exploration and extension either through mathematical manipulation or 
computer simulation.  In this spririt, I provide concise, detailed and commented
...
model, not an assertion about reality.  Only in quantum mechanics do we find 
...
Demographic stochasticity arises
only subsequently, when we change scales from a description at the individual
level to one at the population level.


@Keeling2012; @Melbourne2012; @Ripa2012

This does not attempt to summarize all of the literature on the origins and
types of noise, which have been reviewed elsewhere [e.g. @Saether1997; @Coulson2004; @Ovaskainen2010; @Black2012; @Schreiber2012; @Lenormand2009]

justify simple models, 
citations adapting this to complex models:
...
simulates each individual birth or death as a separate event. Figure \ref{gillespie}
...
parameters or candidate models. Thus we will not consider model and
parameter uncertainty, as they do not reflect intrinsic phenomena of 
the dynamics but only our own ignorance about those dynamics.  
...
Few topics have recieved greater attention then the question of
the persistence of a given species [@Kendall1949;  @Bartlett1959; @Lande1993; @Saether1998; @Coulson2001; @Schreiber2010]

and coexistence of multiple species

[@Caswell1978; @Tuljapurkar1980; @Chesson1981; @Chesson1982; @Chesson1985; @Chesson1989; @Melbourne2007; @Schreiber2017]


Structured populations 
[@Cohen1979; @Tuljapurkar1989; @Metcalf2015; @Vindenes2017b]

See in particular reviews by @Ovaskainen2010 and @Schreiber2012

Individual heterogeneity 
@Vindenes2015; @Hart2016
...
eventually go extinct under demographic noise [e.g. @Kendall1949; @Lande2003].  However, in most
