...
environment. As the numerical examples clearly illustrate,
these transitions can neverthless be explained entirely by chance
...
has become less stable), the onset of such transitions can be intepreted
...
Our most provacative example of how noisy phenomena can act to reveal
...
experimental manipulation and corrsponding simulated model of
...
mechanistic intepretation of the underlying fold bifurcation.
...
autocorrelated noise etc are significantly underdeveloped. Issues of spatial
structure have recieved more attention [e.g. @Guttal2009; @Dakos2011; @Bel2012; @Dai2013]
but still largely idosynchratic.  Significant challenges remain
...
auto-correllation, and flickering all point to ways in which stochasticty
...
Intepreting stochastic processes as potential new sources of information
