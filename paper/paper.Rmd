...
The gap between theory-focused specialists and more empirically minded non-specialists
is particularly acute in the ecological literature on stochastic processes, making
a review of 
...
in the changing way we think about the role of noise.
...
readers, I will rely on the simplest examples necessary, with only passing
...
and mean $\bar e$, we find the expected variance introduced in the
population to be:
...
that the standard deviation scales in direct proportion to the system size $N$,
