...
Both for clarity of presentation and highlight the generality of 
stochastic switching in diverse models, we will focus not specifically
on the more complex disease model analyzed in @Keeling2001 but
rather rely on the classic resource consumption model of @May1977
