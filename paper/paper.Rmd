...
This result has several potential draw-backs.  First, as noted in @vanKampen2007 or
...
- Link back to Levins, show where same
- IMPORTANCE of fluctuation dissipation theorem to the tranisition probability discussion!!
- ENV noise and colored noise 
...
expression in understanding stochastic dynamics.  Because Eq \eqref{vanKampen}
