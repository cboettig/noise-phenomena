...
the theorems of Kurtz at about the same time [e.g @Kurtz1970; @Kurtz1972; @Kurtz1978; theorem 4.4.].
...
in ecology, noise is viewed largely as a nuisance: something entirely
...
averaged away, since the presence of noise can fundamentally alter the
dynamics we observe.
...
processes goes well beyond avialable examples in stability and early warning signals.
