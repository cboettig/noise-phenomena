...
read_csv("appendix/quasicycles.csv") %>%
  ...
  ggplot(aes(t, pop, col=species)) + geom_line() + 
  facet_wrap(~sigma) + scale_color_ipsum() + 
  labs(x="Time", 
       y="Population density",
       title="Quasi-cycles created by stochastic resonance",
       subtitle="Left panel: neglible  noise results only in damped oscillations.
