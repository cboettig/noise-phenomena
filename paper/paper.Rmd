...
changes *derivative* of the deterministic skeleton ($\partial_x \left[ b(x) - d(x) \right]$ in
...
This term represents the *stability*  of the equilibrium: how quickly
...
This pattern, known as critical slowing
