...
```{r}
# Slow environmental degredation through small stepwise changes (increasing the serial dilution factor, as in the Dai et al experiment.)
...
# Tidy up the result data and write to file, along with analytic prediction for equilibrium
df %>% 
  filter(x > 0) %>% 
  group_by(t) %>%
